...
# Configuration
REPO_URL_SSH="git@github.com:402617833/Hermes-Desktop-CN.git"
REPO_URL_HTTPS="https://github.com/402617833/Hermes-Desktop-CN.git"
...
install_desktop() {
    ...
    ( cd "$desktop_dir" && node scripts/patch-build-config.cjs && CSC_IDENTITY_AUTO_DISCOVERY=false npm run pack ) || {
